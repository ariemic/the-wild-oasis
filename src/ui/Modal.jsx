...
function Open({ children, opens: opensWindowName }) {
  ...
  //* we clone children element and give them new prop: onClick;
  //* we do this because we can't add onClick to Button in Modal.Open where opens=""
  ...
  return createPortal(
    <Overlay>
      <StyledModal ref={ref}>
        ...
        {/* we give as a prop onCloceModal because same name this prop has in CreateCabinFrom  🤯*/}
